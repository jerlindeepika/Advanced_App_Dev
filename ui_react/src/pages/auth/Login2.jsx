        ...
        <div className="w-full h-100">
          ...
          <form className="mt-6" action="#" method="POST">
            <div>
              ...
              <input type="email" name="" id="" placeholder="Enter Email Address" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus autoComplete="email" required />
            </div>
